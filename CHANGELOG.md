...
* Bump dependabot/fetch-metadata from 2.4.0 to 2.5.0 by @dependabot[bot] in https://github.com/codedor/filament-belongs-to-many/pull/33
* Bump actions/checkout from 5 to 6 by @dependabot[bot] in https://github.com/codedor/filament-belongs-to-many/pull/32
* Upgrade to Filament v4 by @jyrkidn in https://github.com/codedor/filament-belongs-to-many/pull/25
* Upgrade to Filament v5 by @jyrkidn in https://github.com/codedor/filament-belongs-to-many/pull/31

**Full Changelog**: https://github.com/codedor/filament-belongs-to-many/compare/v1.2.2...v2.0.0

## v1.2.2 - 2025-11-20

### What's Changed

* Bump aglipanci/laravel-pint-action from 2.5 to 2.6 by @dependabot[bot] in https://github.com/codedor/filament-belongs-to-many/pull/28
* Do not reset selected items, but fetch them again by @jyrkidn in https://github.com/codedor/filament-belongs-to-many/pull/26
* Bump actions/checkout from 4 to 5 by @dependabot[bot] in https://github.com/codedor/filament-belongs-to-many/pull/29
* Bump stefanzweifel/git-auto-commit-action from 5 to 7 by @dependabot[bot] in https://github.com/codedor/filament-belongs-to-many/pull/30

**Full Changelog**: https://github.com/codedor/filament-belongs-to-many/compare/v1.2.1...v1.2.2
